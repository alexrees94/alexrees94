...
domain = ["telerium.tv", "teleriumtv.net", "teleriumtv.com"]
...
def get_m3u8(url):
    ...
    headers = {"User-Agent": user_agent, "Referer": url, "Origin": "https://teleriumtv.com", "Accept": "*/*"}
    ...
    if "tokenurl" in r_streams:
        ...
        token = r_token[10][::-1]
        m3u8 += token
    return m3u8 + f"|Referer={url}&User-Agent={user_agent}"
