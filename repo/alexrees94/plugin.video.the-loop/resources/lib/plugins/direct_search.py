...
from sportjetextractors import extracttv, extractor
...
SEARCH_INCLUDE = ["Direct_CH","Aust","Direct_CH2","Inter_sports","Sling","USTVGO","Yahoo Sports"]
    ...
    def routes(self, plugin):
        ...
        def search(query):
            ...
            with ThreadPoolExecutor(max_workers=128) as executor:
                running_tasks = []
                for module in extracttv.__all__:
